  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        ...
        <meta name="description" content="Full-Stack Web Development spezialisiert auf moderne Web-Anwendungen mit React, Next.js und TypeScript. Performante, skalierbare Lösungen die begeistern." />
        <link rel="icon" href="/favicon.ico" />

        {/* Open Graph / Social Media Tags */}
        <meta property="og:title" content="Klein Digital Solutions - Full-Stack Web Development" />
