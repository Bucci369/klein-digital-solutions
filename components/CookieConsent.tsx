...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 bg-opacity-95 backdrop-blur-sm text-white p-6 shadow-lg">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm md:text-base text-center md:text-left">
          ...
          <Link href="/datenschutz" className="text-blue-400 hover:underline font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-300 w-full sm:w-auto"
          >
            Cookies akzeptieren
          </button>
